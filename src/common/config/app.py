...
define('profile', default = '/tmp/safood.prof', type = str, help = 'profile')
...
define('www_domain', default = 'lc.safood.com', type = str, help = 'photo domain')
define('photo_domain', default = 'photo.lc.safood.com', type = str, help = 'photo domain')
define('avatar_domain', default = 'avatar.lc.safood.com', type = str, help = 'avatar domain')

options.log_file_prefix = 'log/safood/web.log'
